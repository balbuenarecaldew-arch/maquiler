(() => {
  ...
  const DEFAULT_MACHINE = {
    ...
    texts: {
      ...
      galleryIntro: "Mostramos fotos reales del equipo y del tipo de trabajo que podés resolver con la mini cargadora.",
      priceLabel: "Precios",
      ...
      bookingIntro: "Completá el formulario, guardamos la reserva y abrimos WhatsApp con el mensaje ya preparado.",
